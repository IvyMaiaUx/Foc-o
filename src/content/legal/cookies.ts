...
## 2. Como classificamos

**Essenciais** — necessários para o site e o aplicativo funcionarem: manter você conectado, guardar sua decisão sobre cookies e sustentar a navegação. Não podem ser desativados, porque sem eles o serviço não opera.

**Marketing e mensuração** — identificam a origem da visita e medem conversões, para sabermos quais campanhas funcionam. **Só são ativados depois que você aceita** no banner. Antes disso, nenhum rastreador é carregado.
...
Carregadas **somente após o aceite**.
...
**No navegador:** todos os navegadores permitem bloquear ou apagar cookies nas configurações. Bloquear os essenciais impede o funcionamento do login e do aplicativo.
...
Sempre que adicionarmos ou removermos uma tecnologia de rastreamento, atualizaremos esta lista e a data no topo.
