...
export function TrainingBase() {
  ...
  const options = [
    { id: 'beginner', title: 'Iniciante', desc: 'Ainda não sabe comandos.' },
    { id: 'intermediate', title: 'Intermediário', desc: 'Sabe o básico (senta, deita).' },
  ...
  useEffect(() => {
    // Reset commands if level changes to beginner
    if (base === 'beginner') {
      setKnownCommands([]);
    }
  }, [base]);
  ...
  return (
    <AuthLayout 
      ...
      subtitle="Qual o nível de experiência do cão?"
      step="ETAPA 6 DE 7"
    >
      <div className="flex flex-col gap-5 flex-1">
        ...
        <AnimatePresence>
          {(base === 'intermediate' || base === 'advanced') && (
            ...
            >
              <h3 className="text-[#055A43] font-medium text-sm">Quais comandos ele já sabe? (Opcional)</h3>
