...
export function Agenda() {
  ...
  return (
    <div className="flex-1 bg-[#F7F5EF] font-sans min-h-screen pb-24 overflow-x-hidden">
      <div className="max-w-xl mx-auto w-full">
        ...
        >
          ...
          <div className="absolute right-10 top-24 w-24 h-24 rounded-full bg-white/[0.04] pointer-events-none" />
        ...
        {/* White drawer */}
        <main className="relative -mt-6 rounded-t-[26px] bg-[#F7F5EF] flex flex-col gap-8 px-6 pt-7 pb-8">
        <section className="bg-white rounded-[1.5rem] border border-[#055A43]/5 shadow-[0_4px_24px_rgba(45,74,58,0.08)] p-5">
          <div className="flex items-start justify-between gap-4 mb-5">
            <div>
              <h2 className="font-serif text-[19px] text-[#506352]">Personalizar agenda</h2>
              <p className="text-[13px] text-[#6B7A6E] mt-1 leading-relaxed">
                Defina os horários de lembrete para a rotina do cão.
              </p>
            </div>
            {agendaSaved && (
              <span className="rounded-full bg-[#055A43]/10 px-3 py-1 text-[11px] font-semibold text-[#055A43] shrink-0">
                Salvo
              </span>
            )}
          </div>
          ...
          <button
            ...
            className="mt-5 w-full h-12 rounded-xl bg-[#055A43] text-white text-[14px] font-semibold flex items-center justify-center gap-2 active:scale-[0.98] transition-all disabled:opacity-70"
          >
            {isSavingAgenda ? (
        ...
        <section>
          <div className="flex items-center justify-between mb-4">
            <h2 className="font-serif text-[22px] text-[#506352]">Hoje</h2>
            <button
              onClick={() => setIsEventModalOpen(true)}
              className="text-xs font-semibold text-white flex items-center gap-1.5 bg-[#C2703E] px-3.5 py-2 rounded-full shadow-[0_4px_12px_rgba(194,112,62,0.25)] active:scale-95 transition-all cursor-pointer"
            >
          ...
          <div className="flex flex-col gap-3">
             ...
             <div
               ...
               className="flex items-center gap-4 p-4 rounded-2xl border border-[#055A43]/8 bg-white cursor-pointer active:scale-[0.98] transition-all shadow-[0_4px_15px_rgba(45,74,58,0.06)] hover:border-[#055A43]/20"
             >
             ...
             {todaysCustomEvents.map(event => {
                ...
                return (
                  <div
                    key={event.id}
                    className="flex items-center gap-4 p-4 rounded-2xl border border-[#055A43]/8 bg-white shadow-[0_4px_15px_rgba(45,74,58,0.06)] transition-all hover:border-[#055A43]/20"
                  >
                     <button
        ...
        <section>
          <div className="flex items-center justify-between mb-4">
            <h2 className="font-serif text-[22px] text-[#506352]">Em seguida no plano</h2>
            <button onClick={() => navigate('/plano')} className="text-xs font-bold text-[#055A43]">Ver completo</button>
          </div>
          ...
          <div className="flex flex-col gap-2">
            {(!agendaState?.upcomingTasks || agendaState.upcomingTasks.length === 0) ? (
               ...
               agendaState.upcomingTasks.map((t, i) => (
                 <div key={i} className="flex flex-col gap-1 p-3.5 bg-white rounded-xl border border-[#055A43]/8 relative pl-10">
        ...
        {/* Bloco "Esta semana" */}
        <section>
          <h2 className="font-serif text-[22px] text-[#506352] mb-4">Esta semana</h2>

          <div className="flex flex-col gap-3">
             {agendaState?.weeklyPreview?.map((day, idx) => (
                <div key={idx} className="flex gap-4 items-start bg-white p-4 rounded-2xl border border-[#055A43]/8">
                   <div className="w-[50px] flex flex-col items-center justify-center bg-[#F7F5EF] border border-[#055A43]/10 rounded-lg py-2 shrink-0">
        ...
        <section>
          <h2 className="font-serif text-[22px] text-[#506352] mb-4">Próximos cuidados</h2>
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <div className="flex gap-3 mt-4 shrink-0">
                    <button
                      type="button"
                      onClick={() => setIsEventModalOpen(false)}
                      className="flex-1 h-12 rounded-xl border border-gray-200 text-gray-700 text-[14px] font-semibold flex items-center justify-center active:scale-[0.98] transition-all cursor-pointer bg-white"
                    >
                      Cancelar
                    </button>
                    <button
                      ...
                      className="flex-1 h-12 rounded-xl bg-[#055A43] text-white text-[14px] font-semibold flex items-center justify-center active:scale-[0.98] transition-all disabled:opacity-50 cursor-pointer"
                    >
                      {isCreatingEvent ? (
                        <span className="w-5 h-5 border-2 border-white/30 border-t-white rounded-full animate-spin" />
                      ) : (
