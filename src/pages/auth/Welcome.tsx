...
export function Welcome() {
  ...
  return (
    <div className="relative min-h-screen w-full font-sans flex flex-col justify-between overflow-hidden bg-[#041411]">
      {/* Background Deep Botanical / Petroleum Gradients */}
      <div className="absolute inset-0 z-0">
        {/* Top right subtle glow connected to the brand primary color */}
        ...
        {/* Extremely subtle noise texture for editorial, tactile feel */}
        <div 
      ...
      <motion.div
        ...
        className="w-full pt-20 flex justify-center relative z-10"
      >
        <div className="flex flex-col items-center gap-3">
          <span className="font-serif text-[#E0E7E4] tracking-[0.4em] uppercase text-xs opacity-90 drop-shadow-sm">
            Focão
          </span>
          <div className="w-6 h-[1px] bg-[#E0E7E4]/20"></div>
        </div>
      </motion.div>
